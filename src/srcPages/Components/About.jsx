  ...
  return (
    <section id="about" className="about-section">
      ...
      <p>
        ...
        learning experience, making growth both meaningful and enjoyable.
      </p>
      ...
      <div className="feature-desc">
        ...
        <div className="vision">
          ...
          <p>
            ...
            {/* ✅ Fixed: trengths -> strengths */}
            strengths, express themselves freely, and develop the soft skills required to 
            succeed in life.
          </p>
        </div>
